...
s4 = Suggestion.create!(title: "Pick up lunch", description: "Location: Fuku, FiDi", user: david)
s5 = Suggestion.create!(title: "Subway Card", description: "Refill Subway card", user: david)
